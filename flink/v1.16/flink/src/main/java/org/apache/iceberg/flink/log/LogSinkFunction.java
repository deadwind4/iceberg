...
public interface LogSinkFunction<IN> extends SinkFunction<IN> {

  void setWriteCallback(WriteCallback writeCallback);

  /**
   * A callback interface that the user can implement to know the offset of the partition when the
   * request is complete.
   */
  interface WriteCallback {
     ...
     * acknowledged.
     */
    void onCompletion(int partition, long offset);
  }
}
